    ...
    <Box sx={{ mt: 7, mb: 6, width: '100%', px: { xs: 2, md: 4 }, display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 4 }}>
      ...
      <Box sx={{ flex: 1, minWidth: 340, display: 'flex', flexDirection: 'column', gap: 3 }}>
        <Paper elevation={2} sx={{ p: 3, borderRadius: 3, mb: 2, ...cardStyles[2], boxShadow: '0 2px 12px 0 rgba(90, 100, 120, 0.07)' }}>
          <Typography variant="h5" fontWeight={700} mb={2} color="#333">Feedback Form</Typography>
          <Typography variant="body2" color="text.secondary" mb={2}>
            If you would like a response, kindly include your phone number or email in your message. Feedback is anonymous.
          </Typography>
          <form>
            <Stack spacing={2}>
        ...
        <Box textAlign="center">
          ...
          <Stack direction="row" spacing={2} justifyContent="center">
            ...
            <IconButton color="primary" href="https://wa.me/254700000000" target="_blank"><WhatsAppIcon /></IconButton>
            <IconButton color="primary" href="https://youtube.com" target="_blank"><YouTubeIcon /></IconButton>
            <IconButton color="primary" href="tel:+254700000000"><PhoneIcon /></IconButton>
      ...
      <Box sx={{ flex: 1, minWidth: 340, display: 'flex', flexDirection: 'column', gap: 3 }}>
        ...
        <Paper elevation={2} sx={{ p: 3, borderRadius: 3, mb: 2, ...cardStyles[1], boxShadow: '0 2px 12px 0 rgba(90, 100, 120, 0.07)' }}>
          ...
          <Typography variant="body2" color="text.secondary" mb={1}>
            Nairobi Chapel Ngong Road, Nairobi, Kenya
          </Typography>
          <Typography variant="subtitle1" fontWeight={600} mb={1} sx={{ fontSize: 16 }}>Office Location</Typography>
          <Typography variant="body2" color="text.secondary">
            Nairobi Chapel Office, 2nd Floor, Chapel Plaza, Ngong Road, Nairobi
          </Typography>
        </Paper>
      </Box>
    </Box>
